...
export default function Home() {
  return (
    ...
    <div className="lg:min-h-screen w-full">
      ...
      <div className="-z-10 absolute inset-0 m-auto overflow-hidden bg-homeMobile md:bg-home bg-no-repeat"></div>
      ...
      <section className="mx-auto flex max-w-6xl flex-col-reverse gap-2 px-4 pb-12 transition-all md:flex-row md:gap-4">
        ...
        <div className="flex flex-col items-center gap-6 pt-8 text-center md:w-1/2 md:items-center md:gap-10 md:pt-5 md:text-center">
          <Balancer>
            <h1 className="text-6xl font-semibold text-cyan-300 sm:text-cyan-300 sm:text-8xl pb-5">
              SARA
            </h1>
      ...
      <section className="mx-auto flex max-w-6xl flex-col-reverse gap-2 sm:pt-24 px-4 pb-12 transition-all sm:flex-row md:gap-4">
        <div className="flex flex-col items-center gap-6 pt-8 text-center md:w-1/2 md:items-center md:gap-10 md:pt-5 md:text-center">
          <span className="font-semibold text-neutral-200 md:text-neutral-800">
            TAMBIÉN ESTAMOS
          </span>
          <h3 className="font-semibold text-3xl text-neutral-50 md:text-neutral-900">
            En WhatsApp. Prueba una nueva forma de hablar con SARA
          </h3>
          ...
          <div className="flex flex-col-reverse sm:flex-row items-center justify-center gap-6 pt-8 text-center md:w-1/2 md:items-center md:gap-10 md:pt-5 md:text-center">
            <button className="border-white md:border-black w-fit rounded-full border-2 bg-purple-600 px-20 sm:px-6 py-4 text-white transition-all hover:border-purple-600 hover:bg-transparent hover:text-black/90">
              Comenzar
            </button>
            <button className="border-white md:border-black w-fit rounded-full border-2 bg-purple-600 text-nowrap px-20 sm:px-6 py-4 text-white transition-all hover:border-purple-600 hover:bg-transparent hover:text-black/90">
              Saber más
            </button>
          </div>
        </div>
