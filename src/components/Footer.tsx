      ...
      <footer className="max-w-screen-xl px-4 py-8 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        ...
        <nav className="flex flex-wrap justify-center -mx-5 -my-2">
          <div className="px-5 py-2">
            <Link href="/" className="text-base leading-6 text-gray-500 hover:text-purple-900">
              Que es SARA
            </Link>
          </div>
          <div className="px-5 py-2">
            <Link href="/contacto" className="text-base leading-6 text-gray-500 hover:text-purple-900">
              Contacto
            </Link>
          </div>
          <div className="px-5 py-2">
            <Link href="/nosotros" className="text-base leading-6 text-gray-500 hover:text-purple-900">
              Quienes somos
            </Link>
          </div>
          <div className="px-5 py-2">
