...
export function ControlPanel({ totalConversations, lastConversationDate }: ControlPanelProps) {
  return (
    <div className="w-full md:w-1/2 xl:w-1/3 px-6 py-4">
      <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
        ...
        <div className="mx-5">
          <h4 className="text-2xl font-semibold text-gray-700">{totalConversations}</h4>
      ...
      <div className="flex items-center px-5 py-6 mt-4 shadow-sm rounded-md bg-white">
        ...
        <div className="mx-5">
          <h4 className="text-2xl font-semibold text-gray-700">{lastConversationDate?.toLocaleDateString()}</h4>
